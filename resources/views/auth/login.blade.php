    ...
    <div class="container my-flex">
        <div class="row w-100">
            <div class="col-md-6 image-section text-center">
                ...
                <h5>Manage your clients Better. <br>Don't have an account? <a href="{{ route('register') }}" class="link-secondary text-decoration-none">Create account</a></h5>
            </div>
            <div class="col-md-6">
              <!-- Small row -->
               <div class="row">
                ...
                @csrf
                    ...
                    <input type="submit" class="btn my-btn w-100" value="Log In">
                </form>
